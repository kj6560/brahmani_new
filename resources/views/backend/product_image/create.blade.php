                    ...
                    <form method="POST" action="/admin/products/images/store" enctype="multipart/form-data"
                        ...
                        <div class="col" style="margin: 20px;">
                            <div class="form-group">
                                ...
                                <select name="product_id" class="form-select" id="exampleSelectGender">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-xs-12">
                                    <input type="file" class="form-control file-upload-info" name="images[]"
                                        multiple placeholder="Multiple Product images">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputUsername1">Product Alias</label>
                                <textarea class="exp_text" name="image_alias" rows="5"
                                    id="image_alias"></textarea>
                            </div>
