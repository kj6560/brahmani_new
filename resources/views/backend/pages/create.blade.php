...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-11 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{!empty($page) && $page->id ? "Edit" : "Create"}} Page
                    ...
                    <form method="POST" action="/admin/categories/store" enctype="multipart/form-data"
                        ...
                        <div class="col" style="margin: 20px;">
                            ...
                            <div class="form-group">
                                <label for="exampleInputUsername1">Page Url</label>
                                <input type="text" name="page_url"
                                    value="{{!empty($page) && $page->page_url ? $page->page_url : old('page_url')}}"
                                    class="form-control" id="exampleInputUsername1">
                            </div>
                            <div class="form-group">
