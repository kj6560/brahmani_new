  ...
  <div class="card">
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          <a class="btn btn-primary" href="/admin/emailSettings/template/create"><i class="fa fa-solid fa-plus"></i>
            New Email Template</a>
        </div>
      </div>
      <div class="table-responsive text-nowrap" style="margin: 10px;padding: 10px;">
        <table class="table .table-bordered " id="templates">
          <thead>
...
<script>
  $(document).ready(function () {
    ...
    $('#templates').DataTable({
      ...
      language: {
        search: "Search Templates:" // Customize the search label
      }
    });
  });
</script>
