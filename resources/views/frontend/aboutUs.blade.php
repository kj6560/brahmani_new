						...
						<div class="about-us-three-content">
							<div class="pbmit-heading-subheading animation-style2">
								...
								<div class="pbmit-heading-desc">
									At Brahmani Enterprises, we're more than just a supplier of construction materials.
									We're your partners in building. For over 16 years, we've been dedicated to providing
									the highest quality PVC panels, louvers, gypsum boards, and a wide range of other
									construction materials to builders, contractors, and homeowners across India. Our
									commitment to quality, customer satisfaction, and innovation drives everything we do. We
									believe in building strong, lasting relationships with our clients, and we strive to
									...
									<div class="pbmit-fld-wrap">
										...
										<h4 class="pbmit-fid-inner">
											...
											<span class="pbmit-number-rotate numinate" data-appear-animation="animateDigits"
												data-from="0" data-to="16" data-interval="1" data-before=""
												data-before-style="" data-after="" data-after-style="">16</span>
								...
								<div class="pbmit-fld-contents">
									<div class="pbmit-fld-wrap">
										...
										<h4 class="pbmit-fid-inner">
											<span class="pbmit-fid-before"></span>
											<span class="pbmit-number-rotate numinate" data-appear-animation="animateDigits"
												data-from="0" data-to="600" data-interval="50" data-before=""
												data-before-style="" data-after="" data-after-style="">600</span>
					...
					<div class="col-md-12 col-xl-6">
						<div class="before-after-left-area pbmit-bg-color-blackish">
							<div class="pbmit-heading-subheading animation-style4">
								...
								<div class="pbmit-heading-desc">We believe that exceptional spaces begin with exceptional
									materials. We offer a comprehensive range of high-quality construction products, from
									durable PVC panels to elegant gypsum boards, designed to transform your vision into
									reality. Whether you're building a home, designing an office, or creating a stunning
									restaurant, we have the materials to bring your unique style to life.
								</div>
							</div>
							<div class="row pbmit-fid-style-one">
								<div class="col-md-6">
									<div class="pbminfotech-ele-fid-style-1">
										<div class="pbmit-fld-contents d-flex align-items-center">
											<div class="pbmit-circle-outer" data-digit="95" data-fill="#bb9a65"
												data-emptyfill="" data-before="" data-after="<span>%</span>"
												data-thickness="1" data-size="127">
								...
								<div class="col-md-6">
									<div class="pbminfotech-ele-fid-style-1">
										<div class="pbmit-fld-contents d-flex align-items-center">
											<div class="pbmit-circle-outer" data-digit="99" data-fill="#bb9a65"
												data-emptyfill="" data-before="" data-after="<span>%</span>"
												data-thickness="1" data-size="127">
												<div class="pbmit-circle">
													<div class="pbmit-fid-inner">
							...
							<div class="pbmit-ihbox-headingicon">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
										<img src="{{asset('brahmani_frontend_assets')}}/images/homepage-3/ihbox/ih-award01.png"
											alt="">
									</div>
								</div>
					...
					<div class="pbmit-col-20">
						<div class="pbmit-ihbox-style-10">
							<div class="pbmit-ihbox-headingicon">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
										<img src="{{asset('brahmani_frontend_assets')}}/images/homepage-3/ihbox/ih-award02.png"
											alt="">
									</div>
								</div>
								<div class="pbmit-ihbox-contents">
					...
					<div class="pbmit-col-20">
						<div class="pbmit-ihbox-style-10">
							<div class="pbmit-ihbox-headingicon">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
										<img src="{{asset('brahmani_frontend_assets')}}/images/homepage-3/ihbox/ih-award03.png"
											alt="">
									</div>
								</div>
								<div class="pbmit-ihbox-contents">
					...
					<div class="pbmit-col-20">
						<div class="pbmit-ihbox-style-10">
							<div class="pbmit-ihbox-headingicon">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
										<img src="{{asset('brahmani_frontend_assets')}}/images/homepage-3/ihbox/ih-award04.png"
											alt="">
									</div>
								</div>
								<div class="pbmit-ihbox-contents">
					...
					<div class="pbmit-col-20">
						<div class="pbmit-ihbox-style-10">
							<div class="pbmit-ihbox-headingicon">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
										<img src="{{asset('brahmani_frontend_assets')}}/images/homepage-3/ihbox/ih-award05.png"
											alt="">
									</div>
								</div>
								<div class="pbmit-ihbox-contents">
					...
					<article class="pbmit-miconheading-style-4 col-md-6 col-lg-3">
						<div class="pbmit-ihbox-style-4">
							<div class="pbmit-ihbox-headingicon">
								...
								<div class="pbmit-heading-desc">Our experienced team provides personalized consultation to
									help you select the right materials for your specific project needs.</div>
							</div>
						</div>
					</article>
					<article class="pbmit-miconheading-style-4 col-md-6 col-lg-3">
						<div class="pbmit-ihbox-style-4">
							<div class="pbmit-ihbox-headingicon">
								...
								<div class="pbmit-heading-desc">We source and supply only the highest quality materials from
									trusted manufacturers to ensure durability and longevity.</div>
							</div>
						</div>
					</article>
					<article class="pbmit-miconheading-style-4 col-md-6 col-lg-3">
						<div class="pbmit-ihbox-style-4">
							<div class="pbmit-ihbox-headingicon">
								...
								<div class="pbmit-heading-desc">We prioritize timely delivery to ensure your project stays
									on schedule and minimizes disruptions.</div>
							</div>
						</div>
					</article>
					<article class="pbmit-miconheading-style-4 col-md-6 col-lg-3">
						<div class="pbmit-ihbox-style-4">
							<div class="pbmit-ihbox-headingicon">
								...
								<div class="pbmit-heading-desc">We are committed to providing eco-friendly and sustainable
									construction solutions that minimize environmental impact.</div>
							</div>
						</div>
					</article>
				</div>
				<div class="pbmit-text-editor">
					<span class="pbmit-text-design">Hurry</span> Let’s make something great work together. Got a project in
					mind? <span class="pbmit-globalcolor"><u><a href="/contact_us">Contact us now</a></u></span>
				</div>
			</div>
		</section>
		<!-- Process End -->
